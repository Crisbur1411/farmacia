    ...
    <div class="registration-form">
        <form>
            ...
            <div class="form-group">
                <input type="text" class="form-control item" id="Nombre" placeholder="Nombre(s)">
            </div>
            <div class="form-group">
                <input type="text" class="form-control item" id="A_paterno" placeholder="Apellido paterno">
            </div>
            <div class="form-group">
                <input type="text" class="form-control item" id="A_materno" placeholder="Apellido materno">
            </div>
            <div class="form-group">
                <input type="text" class="form-control item" id="F_N" placeholder="Fecha de Nacimiento">
            </div>
            <div class="form-group">
