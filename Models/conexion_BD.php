...
class Conexion {
    ...
    private $password = "021114"; // Contraseña de la base de datos
    private $base_datos = "farmacia"; // Nombre de la base de datos
    ...
    public function __construct() {
        ...
        echo ""; // Esto es opcional, solo para verificar que la conexión se realizó con éxito
    }
